...
__all__ = [
    'SPEI_INTERFERENCE', 'SPSERIALIZEDPHRASE', 'ISpRecoResult',
    'SPXRO_Alternates_SML', 'DISPID_SVESentenceBoundary',
    'SVEAllEvents', 'ISpRecoGrammar2',
    'SpeechPropertyLowConfidenceThreshold', 'SPEI_RECO_OTHER_CONTEXT',
    'SPAR_Low', 'SpeechAudioFormatGUIDWave', 'SITooFast',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SOTDisplayUI',
    'DISPID_SpeechLexiconProns', 'SAFT12kHz16BitStereo',
    'DISPID_SAFGetWaveFormatEx', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpSharedRecoContext', 'ISpeechPhraseElements',
    'Speech_Max_Word_Length', 'SAFT32kHz8BitStereo',
    'SSSPTRelativeToCurrentPosition', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SVAlertBoundary', 'DISPID_SPIProperties',
    'ISpeechLexiconPronunciations', 'SPSNoun', 'ISpeechCustomStream',
    'DISPID_SOTGetAttribute', 'SP_VISEME_10', 'SpeechAudioFormatType',
    'ISpeechGrammarRules', 'DISPID_SRCVoice', 'SREBookmark',
    'DISPID_SPRuleFirstElement', 'SPEI_VOICE_CHANGE',
    'DISPID_SRCResume', 'DISPID_SRRTTickCount',
    'DISPIDSPTSI_SelectionOffset', 'eLEXTYPE_PRIVATE6',
    'DISPID_SVEViseme', 'SAFTCCITT_ALaw_22kHzMono',
    'Speech_StreamPos_RealTime', 'DISPID_SVWaitUntilDone',
    'SPINTERFERENCE_NOSIGNAL', 'SpeechRuleState', 'SpStream',
    'DISPID_SVSInputSentenceLength', 'SRSEDone', 'SPEI_HYPOTHESIS',
    'SRCS_Disabled', 'DISPID_SGRSTWeight', 'SVSFIsNotXML',
    'SpeechDiscardType', 'SAFTGSM610_11kHzMono',
    'DISPID_SRRGetXMLErrorInfo', 'SPPS_Function', 'SITooQuiet',
    'DISPID_SGRClear', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SLPLangId', 'ISpStream', 'SpeechTokenKeyFiles',
    'SECFNoSpecialChars', 'SPDATAKEYLOCATION', 'SPWF_SRENGINE',
    'SP_VISEME_3', 'DISPID_SVPriority', 'SPCT_COMMAND',
    'STSF_CommonAppData', 'DISPID_SpeechVoiceEvent',
    'ISpPhoneticAlphabetSelection', 'ISpShortcut', 'SRTReSent',
    'SVEPrivate', 'SPCONTEXTSTATE', 'SPSEMANTICERRORINFO',
    'DISPID_SRRAudio', 'SpeechRegistryUserRoot', 'UINT_PTR',
    'SGRSTTDictation', 'ISpeechLexicon', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SOTId', 'STCLocalServer', 'SGDisplay', 'IEnumString',
    'SpPhraseInfoBuilder', 'SPEI_PROPERTY_NUM_CHANGE',
    'eLEXTYPE_PRIVATE17', 'SpSharedRecognizer',
    'DISPID_SRGDictationLoad', 'SAFT24kHz8BitStereo',
    'ISpResourceManager', 'SECFIgnoreKanaType',
    'DISPID_SOTIsUISupported', 'SPSVerb', 'SpeechLoadOption',
    'SAFT48kHz8BitMono', 'DISPID_SRCEPropertyStringChange', 'IStream',
    'ISpeechRecognizer', 'DISPID_SGRsDynamic', 'ISpeechGrammarRule',
    'DISPID_SpeechRecoResultTimes', 'ISpPhrase', 'DISPID_SVRate',
    'ISpeechRecoResult2', 'SpeechPropertyResourceUsage',
    'DISPID_SRSetPropertyString', 'SPWT_LEXICAL',
    'DISPID_SVEEnginePrivate', 'ISpeechBaseStream',
    'DISPID_SPRulesItem', 'DISPID_SLWs_NewEnum', 'SPEI_END_SR_STREAM',
    'SpeechRuleAttributes', 'SPEVENTENUM', 'SpeechTokenShellFolder',
    'SPPHRASEELEMENT', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'eLEXTYPE_LETTERTOSOUND', 'ISpNotifySource', 'SPVISEMES',
    'DISPID_SVSLastResult', 'STCAll', 'SpeechCategoryVoices',
    'DISPID_SVSpeakCompleteEvent', 'SRAExport', 'SPEI_SR_BOOKMARK',
    'DISPID_SMSGetData', 'SpeechEngineConfidence', 'SpObjectToken',
    'SPEI_SOUND_START', 'ISpRecognizer3', 'DISPID_SASNonBlockingIO',
    'SAFT32kHz16BitStereo', 'ISpeechPhraseRule', 'SINoise',
    'SP_VISEME_12', 'SPCT_SUB_COMMAND', 'SAFT22kHz8BitMono',
    'eLEXTYPE_PRIVATE2', 'DISPID_SASState', 'SpObjectTokenCategory',
    'eLEXTYPE_PRIVATE16', 'SPRST_INACTIVE', 'SPLO_DYNAMIC',
    'SGRSTTRule', 'DISPID_SRCRetainedAudio',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SRSetPropertyNumber',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPFM_CREATE',
    'DISPID_SRCRequestedUIType', 'SP_VISEME_13', 'DISPID_SRCPause',
    'SRSInactive', 'SAFT11kHz16BitMono', 'DISPID_SpeechObjectTokens',
    'SAFTADPCM_8kHzStereo', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SpeechDataKey', 'SpeechPropertyAdaptationOn',
    'SPDKL_CurrentConfig', 'DISPID_SRGCmdLoadFromResource',
    'SPAUDIOBUFFERINFO', 'SLTUser', 'SVP_0', 'SPEI_SOUND_END',
    'SPINTERFERENCE_TOOFAST', '__MIDL_IWinTypes_0009',
    'DISPID_SRGRules', 'SAFTGSM610_8kHzMono',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRCVoicePurgeEvent', 'SPVPRI_ALERT', 'SAFTADPCM_8kHzMono',
    'DISPID_SLWPronunciations', 'SVSFNLPMask', 'SPGRAMMARSTATE',
    'ISpPhoneConverter', 'SASRun', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SLWWord', 'DISPID_SLPs_NewEnum',
    'SpeechCategoryAppLexicons', 'SRARoot', 'DISPID_SPPsItem',
    'DISPID_SPIEnginePrivateData', 'DISPID_SDKOpenKey', 'SRAImport',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SOTGetDescription', 'SPSHT_Unknown',
    'DISPID_SVSLastBookmark', 'DISPID_SRRRecoContext',
    'SAFT16kHz16BitMono', 'DISPID_SRSNumberOfActiveRules', 'SVP_20',
    'DISPID_SPPFirstElement', 'DISPID_SRRSaveToMemory',
    'DISPID_SVEBookmark', 'SPEI_ADAPTATION', 'SpMMAudioIn',
    'SPEI_RESERVED3', 'SpeechRecoProfileProperties', 'SPVPRI_OVER',
    'SAFT48kHz16BitStereo', 'DISPID_SRCEventInterests', 'SPPHRASE',
    'tagSPTEXTSELECTIONINFO', 'SDTAll', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRRTStreamTime', 'SP_VISEME_1',
    'DISPID_SRCCmdMaxAlternates', 'SP_VISEME_20',
    'SpeechEmulationCompareFlags', 'SVP_9',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SPIElements',
    'DISPID_SGRSTs_NewEnum', 'SPPS_Noncontent', 'SPLEXICONTYPE',
    'SFTSREngine', 'ISpeechVoiceStatus', 'DISPID_SVGetVoices',
    'SpeechGrammarState', 'DISPID_SpeechCustomStream',
    'DISPID_SpeechRecoResult', 'ISpPhraseAlt',
    'SPEI_SENTENCE_BOUNDARY', 'SP_VISEME_17', 'ISpeechObjectToken',
    'SPEI_PHONEME', 'eLEXTYPE_PRIVATE15', 'eLEXTYPE_PRIVATE14',
    'DISPID_SASFreeBufferSpace', 'DISPID_SPEAudioTimeOffset',
    'SRAORetainAudio', 'DISPID_SPILanguageId', 'SDTPronunciation',
    'SPAUDIOOPTIONS', 'ISpPhoneticAlphabetConverter', 'SGDSInactive',
    'DISPID_SRProfile', 'SASClosed', 'SPEI_PROPERTY_STRING_CHANGE',
    'SpeechDataKeyLocation', 'SPEI_END_INPUT_STREAM',
    'DISPID_SPEDisplayText', 'SPGS_DISABLED',
    'SpeechCategoryPhoneConverters', 'SPEI_VISEME', 'SPPHRASERULE',
    'SPEI_TTS_PRIVATE', 'eLEXTYPE_PRIVATE18',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SABIBufferSize',
    'DISPID_SLGenerationId', 'SVSFParseAutodetect', 'SVSFVoiceMask',
    'SDA_One_Trailing_Space', 'ISpeechPhraseInfo',
    'DISPID_SDKGetlongValue', 'SREStreamEnd', 'SVSFParseMask',
    'DISPID_SDKEnumValues', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SpeechAudioBufferInfo', 'SGSEnabled',
    'DISPID_SVEventInterests', 'DISPIDSPTSI', 'SPFM_OPEN_READWRITE',
    'SpeechAddRemoveWord', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SRRAudioFormat', 'SVP_11', 'SVPOver', 'SPEI_MAX_TTS',
    'DISPID_SMSADeviceId', 'SP_VISEME_2', 'DISPID_SPRuleConfidence',
    'SPBO_AHEAD', 'IEnumSpObjectTokens', 'DISPID_SAFType',
    'SAFTNoAssignedFormat', 'SPSHORTCUTPAIRLIST', 'SPRULESTATE',
    'SPEI_SR_PRIVATE', 'eLEXTYPE_PRIVATE20', 'DISPID_SLWType',
    'ISpXMLRecoResult', 'DISPID_SpeechPhraseProperty',
    'SpeechBookmarkOptions', 'DISPID_SGRSTsItem',
    'SPXMLRESULTOPTIONS', 'ISpeechPhoneConverter', 'DISPID_SVPause',
    'DISPID_SRGDictationSetState', 'DISPID_SRGRecoContext',
    'DISPID_SPERetainedSizeBytes', 'SASStop',
    'DISPID_SRSCurrentStreamNumber', 'SpPhoneConverter',
    'SPVOICESTATUS', 'DISPID_SpeechAudioStatus', 'DISPID_SVSVisemeId',
    'DISPID_SLRemovePronunciation', 'ISpeechTextSelectionInformation',
    'DISPID_SOTCEnumerateTokens', 'SVSFPurgeBeforeSpeak',
    'SPEI_PHRASE_START', 'SVEViseme', 'SPFILEMODE',
    'SAFT8kHz8BitStereo', 'ISpeechDataKey', 'DISPID_SPRuleName',
    'DISPID_SLWsItem', 'SpeechRecognitionType', 'SPPS_Unknown',
    'ISpRecoContext', 'SPSHT_OTHER', '_RemotableHandle',
    'DISPID_SRSSupportedLanguages', 'SRTAutopause', 'SLODynamic',
    'eLEXTYPE_PRIVATE4', 'DISPID_SGRs_NewEnum', 'SINoSignal',
    'ISpeechRecoResult', 'SPEI_FALSE_RECOGNITION',
    'SpeechVoiceSkipTypeSentence', 'ISpGrammarBuilder',
    'DISPID_SRRTOffsetFromStart', 'SVPAlert',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPWORD', 'SAFT44kHz8BitMono',
    'SECHighConfidence', 'DISPID_SOTCId', 'DISPID_SpeechFileStream',
    'SpeechPropertyNormalConfidenceThreshold', 'STSF_AppData',
    'DISPID_SOTCGetDataKey', 'SAFT12kHz16BitMono',
    'DISPID_SDKGetBinaryValue', 'SPWORDTYPE',
    'DISPID_SRGDictationUnload', 'DISPID_SVSInputWordLength',
    'SPAR_High', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SLPPhoneIds', 'SpeechPropertyHighConfidenceThreshold',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRCEFalseRecognition',
    'SWPUnknownWordPronounceable', 'SSTTWildcard',
    'DISPID_SGRAddState', 'DISPID_SVIsUISupported',
    'DISPID_SVEStreamEnd', 'DISPID_SPRs_NewEnum',
    'DISPID_SpeechVoice', 'SPWAVEFORMATTYPE',
    'SREPropertyStringChange', 'SPINTERFERENCE_TOOQUIET',
    'SRTSMLTimeout', 'DISPID_SPERetainedStreamOffset',
    'SpeechCategoryRecognizers', 'ISpEventSource', 'SPAS_RUN',
    'ISpMMSysAudio', 'SpeechCategoryAudioIn', 'SLOStatic',
    'DISPID_SRCRecognizer', 'SpeechGrammarTagDictation',
    'ISpeechWaveFormatEx', 'DISPID_SGRSAddWordTransition', 'SDTAudio',
    'DISPID_SPANumberOfElementsInResult', 'SVP_8',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SPPId',
    'Speech_StreamPos_Asap', 'DISPID_SGRsAdd', 'SRATopLevel',
    'DISPID_SPPs_NewEnum', 'SRERecognition', 'SPAS_STOP',
    'DISPID_SABufferNotifySize', 'SAFT24kHz8BitMono', 'SPSUnknown',
    'SPSModifier', 'ISpNotifySink', 'SWTDeleted',
    'DISPID_SRCEInterference', 'DISPID_SGRSTsCount',
    'DISPID_SVSInputSentencePosition', 'SVF_Stressed',
    'SAFT8kHz16BitMono', 'SpeechGrammarRuleStateTransitionType',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SPRsCount',
    'SpeechAudioProperties', 'eLEXTYPE_PRIVATE12',
    'SpPhoneticAlphabetConverter', 'DISPID_SVVoice',
    'DISPID_SRCEEndStream', 'DISPID_SGRSAddRuleTransition',
    'SDTAlternates', 'SpeechStreamFileMode', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRCERecognizerStateChange', 'SAFTCCITT_ALaw_44kHzMono',
    'SPAO_NONE', 'DISPID_SPCIdToPhone', 'DISPID_SGRSTRule',
    'SAFT12kHz8BitStereo', 'eLEXTYPE_PRIVATE5', 'SLTApp', 'SVP_12',
    'DISPID_SPAStartElementInResult', 'SGPronounciation',
    'SpeechRecoEvents', 'DISPID_SAStatus', 'DISPID_SBSFormat',
    'ISpStreamFormatConverter', 'SPLOADOPTIONS', 'SpeechLexiconType',
    'ISpeechAudio', 'DISPID_SLWsCount', 'eLEXTYPE_USER',
    'SREAllEvents', 'DISPID_SRGetPropertyString', 'ISpSerializeState',
    'eLEXTYPE_APP', 'DISPID_SpeechVoiceStatus', 'DISPID_SPAs_NewEnum',
    'SAFTCCITT_ALaw_8kHzStereo', 'SITooLoud', 'SAFT44kHz16BitStereo',
    'ISpeechFileStream', 'ISpeechVoice', 'SDKLDefaultLocation',
    'tagSPPROPERTYINFO', 'DISPID_SRGSetWordSequenceData',
    'SPBINARYGRAMMAR', 'DISPID_SRCEPhraseStart',
    'DISPID_SWFEAvgBytesPerSec', 'SRSActiveAlways',
    'ISpeechRecoResultTimes', 'SpeechVoiceSpeakFlags',
    'SpeechRunState', 'DISPID_SRGSetTextSelection',
    'SpeechDictationTopicSpelling', 'DISPID_SRGCmdSetRuleState',
    'ISpStreamFormat', 'SPEI_RECOGNITION',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SpeechDisplayAttributes',
    'DISPID_SPIGetText', 'SDTLexicalForm', 'DISPID_SMSALineId',
    'SDKLLocalMachine', 'SpeechGrammarTagUnlimitedDictation',
    'SPCT_DICTATION', 'SPCT_SUB_DICTATION', 'DISPID_SpeechLexicon',
    'DISPID_SASCurrentDevicePosition', 'SpeechVoiceEvents',
    'SECFDefault', 'DISPID_SRCEStartStream', 'DISPID_SRCEHypothesis',
    'eWORDTYPE_DELETED', 'DISPID_SVAudioOutputStream',
    'ISpeechPhraseRules', 'SpCustomStream',
    'DISPID_SRGIsPronounceable', 'SWPKnownWordPronounceable',
    'SAFTADPCM_11kHzStereo', 'SPVPRIORITY', 'DISPID_SGRsFindRule',
    'SVSFUnusedFlags', 'ISpProperties', 'SAFT11kHz8BitMono',
    'SPRECOGNIZERSTATUS', 'SpMMAudioOut', 'ISpeechLexiconWords',
    'SPWORDPRONUNCIATION', 'DISPID_SRRGetXMLResult',
    'SpeechCategoryRecoProfiles', 'ISpeechAudioBufferInfo',
    'SpNullPhoneConverter', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPRFirstElement', 'DISPID_SAVolume', 'DISPID_SOTRemove',
    'SSFMCreate', 'SAFT32kHz8BitMono', 'SPINTERFERENCE_TOOLOUD',
    'SPPHRASEREPLACEMENT', 'SINone', 'DISPID_SRDisplayUI',
    'eLEXTYPE_PRIVATE1', 'SVP_13', 'DISPID_SpeechAudioFormat',
    'SDA_Consume_Leading_Spaces', 'SPSSuppressWord',
    'DISPID_SRGetFormat', 'DISPID_SRSClsidEngine', 'SGSExclusive',
    'WAVEFORMATEX', 'DISPID_SRRTimes', 'SECLowConfidence',
    'SAFT22kHz16BitMono', 'DISPID_SPRules_NewEnum',
    'DISPID_SpeechRecoContextEvents', 'SPFM_NUM_MODES',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpeechPhraseInfoBuilder',
    'DISPID_SpeechLexiconWord', 'eLEXTYPE_PRIVATE19',
    'IInternetSecurityManager', 'SPCATEGORYTYPE', 'DISPID_SPCLangId',
    'SREHypothesis', 'STCInprocHandler', 'SECNormalConfidence',
    'SpeechGrammarTagWildcard', 'DISPID_SVAudioOutput',
    'DISPID_SpeechPhoneConverter', 'DISPID_SRRPhraseInfo',
    'SPSERIALIZEDRESULT', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPEDisplayAttributes', 'DISPID_SOTCSetId',
    'DISPID_SABufferInfo', 'DISPID_SGRId', 'IInternetSecurityMgrSite',
    'SSSPTRelativeToEnd', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SpeechXMLRecoResult', 'ISpeechMMSysAudio',
    'DISPID_SDKCreateKey', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SGRAttributes', 'DISPID_SRCCreateGrammar',
    'SPPS_RESERVED4', 'ISpeechXMLRecoResult', 'ISpRecoContext2',
    'SECFEmulateResult', 'SpeechAudioVolume', 'STSF_FlagCreate',
    'SPPS_Modifier', 'DISPID_SPRuleParent',
    'DISPID_SWFESamplesPerSec', 'DISPID_SLPType', 'SAFTText',
    'ISpeechRecognizerStatus', 'SAFT8kHz8BitMono',
    'DISPID_SVGetAudioInputs', 'DISPID_SOTDataKey',
    'DISPID_SpeechPhraseReplacements', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SVEStreamStart', 'SPRECOCONTEXTSTATUS',
    'DISPID_SLGetPronunciations', 'DISPID_SOTCDefault',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SVSLastBookmarkId',
    'SGRSTTEpsilon', 'SPBO_PAUSE', 'Speech_Max_Pron_Length',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SPCT_SLEEP',
    'DISPID_SABIMinNotification', 'DISPID_SpeechRecognizer',
    'ISpeechPhraseAlternates', 'DISPID_SPRuleId',
    'DISPID_SRGCmdLoadFromObject', 'SpeechPropertyResponseSpeed',
    'SPEI_RESERVED6', 'SPRST_ACTIVE_ALWAYS',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpeechRecoResultDispatch',
    'DISPID_SpeechMMSysAudio', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SpeechPhraseProperties', 'DISPID_SGRInitialState',
    'ISpRecognizer', 'ISpRecoGrammar', 'SVESentenceBoundary',
    'SVP_17', 'DISPID_SLPsCount', 'SRESoundEnd',
    'DISPID_SGRSAddSpecialTransition', 'SPEI_RESERVED2',
    'DISPID_SREmulateRecognition', 'DISPID_SVEPhoneme',
    'SPEI_TTS_AUDIO_LEVEL', 'tagSTATSTG', 'SpeechWordType',
    'DISPID_SWFEExtraData', 'DISPID_SVEWord', 'SREAudioLevel',
    'SDKLCurrentConfig', 'SpeechPropertyComplexResponseSpeed',
    'SVP_7', 'SP_VISEME_21', 'SVEAudioLevel',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SDKGetStringValue',
    'DISPID_SFSOpen', 'ISpeechPhraseElement', 'SP_VISEME_5',
    'SPPARTOFSPEECH', 'DISPID_SOTMatchesAttributes',
    'DISPID_SFSClose', 'SAFTADPCM_11kHzMono',
    'DISPID_SVSCurrentStreamNumber', 'SRAInterpreter',
    'DISPID_SADefaultFormat', 'SVSFIsFilename', 'SPEI_MIN_SR',
    'DISPID_SWFEBitsPerSample', 'SPPS_Verb', 'DISPID_SpeechAudio',
    'DISPID_SRCEAudioLevel', 'DISPID_SGRSTPropertyValue', 'SRAONone',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SVEVoiceChange', 'DISPID_SPIEngineId',
    'DISPID_SASetState', 'DISPID_SVSpeak', 'DISPID_SWFEFormatTag',
    'DISPID_SpeechPhraseBuilder', 'SpCompressedLexicon',
    'DISPID_SGRsCommit', 'SpeechMicTraining',
    'DISPID_SRIsUISupported', 'SpeechStreamSeekPositionType',
    'SPRS_ACTIVE_USER_DELIMITED', 'SRESoundStart',
    'DISPID_SVSRunningState', 'SpeechInterference', 'ISpEventSink',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SMSSetData',
    'DISPID_SRGCmdLoadFromMemory', 'SREPropertyNumChange',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SPEsItem',
    'SpeechRetainedAudioOptions', 'SGRSTTTextBuffer',
    'ISpObjectToken', 'LONG_PTR', 'SpeechEngineProperties',
    'SAFTGSM610_22kHzMono', 'DISPID_SRCEAdaptation',
    'DISPID_SRRAlternates', 'SPWORDPRONOUNCEABLE',
    'ISpeechPhraseProperty', 'DISPID_SPPNumberOfElements',
    'DISPID_SRGCommit', 'DISPID_SASCurrentSeekPosition',
    'SpStreamFormatConverter', 'DISPID_SPRuleNumberOfElements',
    'SAFT22kHz16BitStereo', 'SPRST_NUM_STATES', 'SPEVENT',
    'SAFTDefault', 'SVP_18', 'SAFT11kHz16BitStereo',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SVSyncronousSpeakTimeout', 'SPDKL_CurrentUser',
    'SAFT16kHz16BitStereo', 'ISpeechLexiconPronunciation',
    'ISpeechAudioFormat', 'SVSFParseSsml', 'SPAS_PAUSE',
    'DISPID_SPAsItem', 'DISPID_SpeechPhraseElement',
    'eLEXTYPE_RESERVED7', 'DISPID_SPPsCount', 'SVSFPersistXML',
    'SPXRO_SML', 'SPEI_RESERVED1', 'SPTEXTSELECTIONINFO',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVP_4',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SGRsItem',
    'eLEXTYPE_PRIVATE10', 'SSFMCreateForWrite', 'SAFT12kHz8BitMono',
    'DISPID_SPELexicalForm', 'SPAO_RETAIN_AUDIO',
    'SAFT44kHz16BitMono', 'SPWORDPRONUNCIATIONLIST',
    'eWORDTYPE_ADDED', 'SPPS_RESERVED3', 'DISPID_SDKDeleteValue',
    'SPEVENTSOURCEINFO', 'SGDSActiveUserDelimited',
    'DISPID_SOTs_NewEnum', 'SpeechTokenKeyAttributes',
    'eLEXTYPE_RESERVED6', 'SPFM_CREATE_ALWAYS', 'DISPID_SDKDeleteKey',
    'SWTAdded', 'SDTReplacement', 'SRTExtendableParse', 'SVP_2',
    'SAFTCCITT_uLaw_44kHzMono', 'SPSInterjection',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISpeechPhraseAlternate',
    'DISPID_SPPConfidence', 'SVEEndInputStream', 'SVP_21',
    'eLEXTYPE_RESERVED9', 'DISPID_SRCESoundStart', 'SVSFNLPSpeakPunc',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SRCERequestUI', 'SVP_15', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRGId', 'SGLexicalNoSpecialChars',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPPS_Noun',
    'SPDKL_DefaultLocation', 'DISPID_SGRAddResource',
    'DISPID_SPRDisplayAttributes', 'eLEXTYPE_RESERVED4',
    'DISPID_SLPSymbolic', 'DISPID_SRCESoundEnd', 'SGSDisabled',
    'SVSFDefault', 'DISPID_SRAudioInput', 'ISpeechMemoryStream',
    'SAFTADPCM_44kHzStereo', 'DISPID_SOTsItem',
    'SpeechRegistryLocalMachineRoot', 'SSSPTRelativeToStart',
    'SPAS_CLOSED', 'DISPID_SWFEBlockAlign', 'DISPID_SOTsCount',
    'SVF_None', 'DISPID_SPAsCount', 'SPINTERFERENCE_NOISE',
    'DISPID_SABIEventBias', 'SAFT11kHz8BitStereo', 'SPSHT_EMAIL',
    'DISPID_SPIRule', 'SSFMOpenForRead', 'SPPS_RESERVED2',
    'DISPID_SRRecognizer', 'SPWT_PRONUNCIATION', 'SSFMOpenReadWrite',
    'DISPID_SRCState', 'SPCS_ENABLED', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SLWLangId', 'DISPID_SRIsShared', 'SDTRule',
    'STSF_LocalAppData', 'SGDSActiveWithAutoPause', 'SPAR_Unknown',
    'DISPID_SpeechPhraseAlternate', 'SVP_1', 'ISpLexicon',
    'SVSFlagsAsync', 'SPEI_UNDEFINED', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPIDSPRG', 'SPPROPERTYINFO', 'SVP_5', 'DISPID_SVVolume',
    'DISPID_SPEAudioSizeTime', 'DISPID_SGRSRule', 'SVP_10',
    'DISPID_SpeechPhraseRule', 'DISPID_SOTGetStorageFileName',
    'SPBO_NONE', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SRCERecognition', 'SAFT44kHz8BitStereo',
    'SAFTCCITT_uLaw_22kHzMono', 'SPPS_Interjection',
    'SpeechCategoryAudioOut', 'DISPID_SOTCreateInstance',
    'DISPID_SGRName', 'DISPID_SGRsCommitAndSave', 'SP_VISEME_14',
    'DISPID_SPRulesCount', 'DISPID_SGRsCount',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SpeechPhraseReplacement',
    'SVEStartInputStream', 'Speech_Default_Weight',
    'DISPIDSPTSI_ActiveLength', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechLexiconPronunciation',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SpeechObjectToken',
    'DISPID_SRRTLength', 'DISPID_SRGCmdLoadFromFile',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SAFGuid',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SLPsItem',
    'SpWaveFormatEx', 'SpeechRecoContextState', 'SpeechAudioState',
    'DISPID_SDKSetStringValue', 'SAFT24kHz16BitMono',
    'SAFTADPCM_22kHzMono', 'DISPID_SVEAudioLevel', 'DISPID_SPRsItem',
    'SAFT8kHz16BitStereo', 'SDA_No_Trailing_Space', 'SSTTDictation',
    'SpTextSelectionInformation', 'DISPID_SRRDiscardResultInfo',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SAFTExtendedAudioFormat',
    'DISPID_SVSLastStreamNumberQueued', 'ISequentialStream',
    'SREStreamStart', 'SITooSlow', 'DISPID_SPEActualConfidence',
    'DISPID_SRGetRecognizers', 'SpeechAudioFormatGUIDText',
    'DISPID_SPPParent', 'SSTTTextBuffer',
    'DISPID_SRCRetainedAudioFormat', 'SPWF_INPUT',
    'eLEXTYPE_MORPHOLOGY', 'SPRST_ACTIVE', 'DISPID_SDKSetBinaryValue',
    'SpeechUserTraining', 'DISPID_SOTSetId', 'ISpDataKey',
    '_ISpeechRecoContextEvents', 'DISPID_SBSWrite', 'DISPID_SRState',
    'DISPID_SAEventHandle', 'DISPID_SPARecoResult', 'DISPID_SVStatus',
    'SWPUnknownWordUnpronounceable', 'SpNotifyTranslator',
    'SVEBookmark', 'DISPID_SOTCategory', 'DISPID_SpeechMemoryStream',
    'ISpeechAudioStatus', 'SBOPause', 'DISPID_SPEs_NewEnum',
    'ISpeechRecoGrammar', 'SPWORDLIST', 'DISPID_SMSAMMHandle',
    'SP_VISEME_15', 'SP_VISEME_0', 'SAFT16kHz8BitStereo',
    'DISPID_SRCreateRecoContext', 'DISPID_SPAPhraseInfo',
    'ISpObjectTokenCategory', 'DISPID_SPACommit', 'DISPID_SPRText',
    'SPRECORESULTTIMES', 'SPSHORTCUTPAIR', 'SpFileStream',
    'SRSInactiveWithPurge', 'SPEI_START_SR_STREAM',
    'DISPID_SPEsCount', 'SREPhraseStart', 'DISPID_SpeechBaseStream',
    'SpeechVisemeFeature', 'ISpAudio', 'ISpeechPhraseProperties',
    'DISPID_SPIStartTime', 'SAFTADPCM_22kHzStereo', 'SPRECOSTATE',
    'SpeechGrammarWordType', 'ISpVoice',
    'DISPID_SPIRetainedSizeBytes', 'SRADefaultToActive',
    'SPAUDIOSTATE', 'SASPause', 'SPEI_REQUEST_UI',
    'SPADAPTATIONRELEVANCE', 'eLEXTYPE_RESERVED10', 'SVF_Emphasis',
    'STCRemoteServer', 'SpeechAllElements', 'DISPID_SRStatus',
    'SAFT22kHz8BitStereo', 'SPFM_OPEN_READONLY', 'SVEWordBoundary',
    'SDTProperty', 'ISpeechLexiconWord', 'SRSEIsSpeaking',
    'SECFIgnoreCase', 'DISPID_SLPPartOfSpeech', 'SpInProcRecoContext',
    'SPPS_LMA', 'DISPID_SWFEChannels', 'SRTEmulated',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SpeechRecoContext',
    'SVSFParseSapi', 'DISPID_SRCSetAdaptationData', 'DISPID_SVSkip',
    'DISPID_SGRSTransitions', 'DISPID_SPISaveToMemory',
    'SpMMAudioEnum', 'DISPID_SCSBaseStream', 'ISpeechResourceLoader',
    'SpeechFormatType', 'SPBOOKMARKOPTIONS',
    'DISPID_SpeechGrammarRuleState', 'ISpObjectWithToken', 'SVP_6',
    'SPEI_SR_AUDIO_LEVEL', 'SPINTERFERENCE_NONE',
    'ISpeechObjectTokenCategory', 'SRTStandard',
    'SAFT48kHz8BitStereo', 'DISPID_SPRNumberOfElements',
    'SPLO_STATIC', 'SPPHRASEPROPERTY', 'SP_VISEME_16',
    'DISPID_SGRSTType', 'eLEXTYPE_PRIVATE3', 'SpAudioFormat',
    'SpeechTokenIdUserLexicon', 'DISPID_SVDisplayUI',
    'SPGRAMMARWORDTYPE', 'SpeechTokenContext', 'SpLexicon',
    'SpeechVoicePriority', 'SPPS_RESERVED1',
    'DISPID_SpeechPhraseRules', 'SpeechVisemeType',
    'SDA_Two_Trailing_Spaces',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SP_VISEME_18',
    'SP_VISEME_7', 'ISpeechGrammarRuleState',
    'DISPID_SRGetPropertyNumber', 'SPSTREAMFORMATTYPE',
    'SPPS_NotOverriden', 'ISpeechPhraseReplacements',
    'SpInprocRecognizer', 'SpMemoryStream',
    'DISPID_SpeechLexiconWords', 'DISPID_SPCPhoneToId',
    'DISPID_SBSRead', 'SPSLMA',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SP_VISEME_19',
    'SRADynamic', 'DISPID_SpeechPhraseElements', 'SRSActive',
    'DISPID_SRRSpeakAudio', 'SVP_3', 'SDKLCurrentUser',
    'SpeechTokenValueCLSID', 'SPEI_MIN_TTS',
    'DISPID_SPEEngineConfidence', 'ISpeechRecoContext', 'SPSMF_UPS',
    'SVPNormal', 'ISpNotifyTranslator',
    'DISPID_SLGetGenerationChange', 'SpeechTokenKeyUI',
    'eLEXTYPE_USER_SHORTCUT', 'SP_VISEME_6', 'SGRSTTWord',
    'SPGS_ENABLED', 'SAFTADPCM_44kHzMono', 'DISPID_SRCEEnginePrivate',
    'ISpeechObjectTokens', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPSEMANTICFORMAT', 'SAFTNonStandardFormat', 'SPSFunction',
    'SRCS_Enabled', 'SGDSActive', 'SREAdaptation', 'SpVoice',
    'DISPID_SRRSetTextFeedback', 'SREStateChange',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SRGState',
    'DISPID_SRGCmdSetRuleIdState', 'SAFT48kHz16BitMono',
    'DISPID_SGRSTPropertyName', 'SpUnCompressedLexicon',
    'eLEXTYPE_RESERVED8', 'SVEPhoneme', 'DISPID_SPIReplacements',
    'DISPID_SPIGrammarId', 'DISPID_SPPName', 'DISPID_SVSpeakStream',
    'DISPID_SVResume', 'SpeechPartOfSpeech',
    'DISPID_SPPEngineConfidence', 'ISpRecoCategory', 'SVEVoiceChange',
    'ISpeechPhraseReplacement', 'SGRSTTWildcard',
    'DISPID_SpeechGrammarRule', 'SPWT_DISPLAY', 'SPBO_TIME_UNITS',
    'SP_VISEME_4', 'SPRS_INACTIVE',
    'DISPID_SpeechObjectTokenCategory', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPERequiredConfidence',
    '_ISpeechVoiceEvents', 'SAFT24kHz16BitStereo',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechSpecialTransitionType',
    'DISPID_SPPChildren', 'DISPID_SRSAudioStatus', 'SPGS_EXCLUSIVE',
    'SPAUDIOSTATUS', 'SREFalseRecognition', 'SPEI_RESERVED5',
    'SVP_14', 'SP_VISEME_9', 'SpeechRecognizerState',
    'SPDKL_LocalMachine', 'DISPID_SLAddPronunciation', 'SVSFIsXML',
    'SPSHORTCUTTYPE', 'SAFTCCITT_uLaw_11kHzStereo', 'SPSNotOverriden',
    'DISPID_SBSSeek', 'STCInprocServer',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SDKSetLongValue', 'DISPID_SRCEBookmark',
    'DISPID_SVSPhonemeId', 'DISPID_SpeechRecoResult2', 'SPAR_Medium',
    'SPVPRI_NORMAL', 'SPCS_DISABLED', 'DISPID_SVGetAudioOutputs',
    'SBONone', 'DISPID_SRAudioInputStream', 'SP_VISEME_11',
    'SAFT32kHz16BitMono', 'DISPID_SPEAudioSizeBytes', 'SVP_16',
    'DISPID_SRGReset', 'SpeechWordPronounceable', 'SVP_19',
    'SpResourceManager', 'DISPID_SGRSTPropertyId', 'SDTDisplayText',
    'DISPID_SLGetWords', 'SFTInput', 'SPRULE',
    'DISPID_SPEPronunciation', 'DISPID_SPRuleChildren',
    'DISPID_SVGetProfiles', 'DISPID_SRCBookmark', 'SRERequestUI',
    'DISPID_SGRSTNextState', 'DISPID_SVSInputWordPosition',
    'eLEXTYPE_PRIVATE8', 'SECFIgnoreWidth', 'DISPID_SDKEnumKeys',
    'DISPID_SPEAudioStreamOffset', 'SREPrivate', 'SPRS_ACTIVE',
    'DISPID_SGRSTText', 'SPSHT_NotOverriden', 'SPINTERFERENCE',
    'eLEXTYPE_PRIVATE11', 'SpShortcut',
    'ISpeechGrammarRuleStateTransitions', 'SPEI_MAX_SR',
    'SAFTGSM610_44kHzMono',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SP_VISEME_8',
    'SREInterference', 'DISPID_SpeechPhraseInfo', 'SPPS_SuppressWord',
    'SRERecoOtherContext', 'ISpRecognizer2', 'DISPID_SPPValue',
    'SGLexical', 'SAFT16kHz8BitMono', 'DISPID_SpeechGrammarRules',
    '_SPAUDIOSTATE'
]
