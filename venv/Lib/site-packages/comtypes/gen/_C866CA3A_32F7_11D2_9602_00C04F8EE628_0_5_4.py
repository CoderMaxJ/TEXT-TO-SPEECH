...
__all__ = [
    'DISPID_SRDisplayUI', 'DISPID_SASFreeBufferSpace',
    'SVEAudioLevel', 'DISPID_SpeechRecoResult2',
    'DISPID_SVSLastBookmarkId', 'SAFT32kHz16BitMono',
    'ISpeechFileStream', 'ISpeechXMLRecoResult', 'SPRECOSTATE',
    'SBONone', 'DISPID_SRGDictationLoad', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPFM_NUM_MODES', 'DISPID_SGRSTPropertyId', 'SPTEXTSELECTIONINFO',
    'DISPID_SDKGetStringValue', 'SpeechAudioFormatGUIDText',
    'SPVPRI_ALERT', 'SVSFNLPSpeakPunc', 'SDTLexicalForm',
    'SPCT_DICTATION', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SPAsCount', 'DISPID_SRCEAudioLevel',
    'SPDKL_DefaultLocation', 'SFTSREngine', 'DISPID_SGRAddResource',
    'SPEI_RESERVED2', 'DISPID_SPRuleName', 'DISPID_SOTDisplayUI',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SPPsItem',
    'eLEXTYPE_RESERVED4', 'SPAS_STOP', 'SpCustomStream',
    'DISPID_SPRules_NewEnum', 'ISpeechPhraseRules',
    'Speech_StreamPos_RealTime', 'SAFTADPCM_22kHzMono',
    'ISpeechGrammarRuleStateTransitions',
    'SpeechStreamSeekPositionType', 'DISPID_SGRSAddWordTransition',
    'DISPID_SpeechFileStream', 'DISPID_SOTIsUISupported',
    'SpeechCategoryAudioOut', 'SpCompressedLexicon',
    'DISPID_SRGRecoContext', 'ISequentialStream', 'DISPID_SPRsItem',
    'DISPID_SOTSetId', 'SpeechRecognizerState',
    'SAFTNonStandardFormat', 'SGDSInactive',
    'DISPID_SVSInputSentencePosition', 'DISPID_SDKEnumKeys',
    'SPRECOCONTEXTSTATUS', 'SpInprocRecognizer',
    'DISPID_SpeechObjectTokens', 'SPSInterjection',
    'SpSharedRecognizer', 'SPAO_RETAIN_AUDIO',
    'DISPID_SRCRequestedUIType', 'eLEXTYPE_USER',
    'DISPID_SRSClsidEngine', 'DISPID_SPEsItem',
    'SAFT32kHz16BitStereo', 'ISpAudio', 'DISPID_SAFGuid',
    'SAFT32kHz8BitStereo', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPFM_OPEN_READWRITE', 'SPBINARYGRAMMAR',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechDisplayAttributes',
    'ISpeechResourceLoader', 'SVP_15', 'SRSActiveAlways',
    'DISPID_SPRulesItem', 'DISPID_SMSGetData', 'SRSEDone',
    'DISPID_SVVoice', 'SpeechAddRemoveWord', 'SRAExport',
    'SPAS_CLOSED', 'SPCS_ENABLED', 'SVSFNLPMask',
    'DISPID_SAFSetWaveFormatEx', 'SAFT22kHz8BitStereo',
    'SPAUDIOOPTIONS', 'DISPID_SGRsItem', 'DISPID_SRRSaveToMemory',
    'SPEI_WORD_BOUNDARY', 'DISPID_SPAs_NewEnum', 'DISPID_SFSClose',
    'ISpeechGrammarRule', 'SECLowConfidence',
    'SPINTERFERENCE_TOOFAST', 'SVP_16', 'SPEI_RECO_OTHER_CONTEXT',
    'SPVISEMES', 'SPSLMA', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SLAddPronunciation',
    'SpeechEngineConfidence', 'DISPID_SPRuleFirstElement',
    'DISPID_SPIGrammarId', 'SRAORetainAudio',
    'DISPID_SpeechGrammarRuleState',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SRATopLevel',
    'SPPS_NotOverriden', 'SpeechVisemeFeature', 'SPAR_High',
    'DISPID_SLWsCount', 'SAFT11kHz8BitMono', 'DISPID_SVStatus',
    'SVP_4', 'SVEWordBoundary', 'SVP_7', 'SAFTGSM610_44kHzMono',
    'DISPID_SOTsItem', 'DISPID_SOTId', 'SPPHRASEPROPERTY',
    'SP_VISEME_19', 'SVSFIsFilename', 'SPWF_SRENGINE',
    'eLEXTYPE_RESERVED7', 'DISPID_SpeechGrammarRuleStateTransitions',
    'SVP_3', 'SVP_10', 'ISpeechLexiconPronunciations',
    'DISPID_SRCERecognizerStateChange', 'SpeechWordPronounceable',
    'eLEXTYPE_MORPHOLOGY', 'ISpeechRecoGrammar', 'SpMMAudioOut',
    'SSTTTextBuffer', 'SP_VISEME_7', 'DISPID_SRCSetAdaptationData',
    'IInternetSecurityMgrSite', 'SP_VISEME_5', 'SVP_11',
    'SAFTCCITT_ALaw_44kHzMono', 'SPEI_UNDEFINED',
    'SpStreamFormatConverter', 'DISPID_SPCIdToPhone',
    'SPEI_VOICE_CHANGE', 'ISpeechRecognizerStatus',
    'SPPS_SuppressWord', 'SpeechAudioState',
    'DISPID_SRGSetTextSelection', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SPIAudioSizeBytes', 'eLEXTYPE_PRIVATE6',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpRecoGrammar2',
    'DISPID_SGRSTType', 'DISPIDSPTSI', 'DISPID_SVAlertBoundary',
    'SPPS_Interjection', 'SAFTADPCM_44kHzMono', 'SPWORD',
    'SPGRAMMARSTATE', 'SRSActive', 'DISPID_SRGSetWordSequenceData',
    'DISPIDSPTSI_ActiveLength', 'ISpXMLRecoResult',
    'SpeechStreamFileMode', 'SSFMOpenForRead',
    'SpeechGrammarTagDictation', 'ISpeechCustomStream',
    'DISPID_SRCAudioInInterferenceStatus', 'SAFT12kHz16BitMono',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SOTGetStorageFileName',
    'SAFTCCITT_ALaw_8kHzMono', 'SRSInactive', 'IEnumSpObjectTokens',
    'SpFileStream', 'ISpMMSysAudio', 'DISPID_SVVolume',
    'DISPID_SVDisplayUI', 'SPRECORESULTTIMES', 'SWTAdded',
    'DISPID_SpeechVoiceEvent', 'DISPID_SRCPause',
    'DISPID_SpeechVoiceStatus', 'DISPID_SRCCreateGrammar',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SLPs_NewEnum',
    'DISPID_SRRGetXMLResult', 'ISpPhoneConverter',
    'DISPID_SGRSTsCount', 'ISpeechRecoResultDispatch',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SVSFParseMask',
    'SITooFast', 'DISPID_SBSWrite', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRCVoice', 'eLEXTYPE_LETTERTOSOUND', 'SPFM_OPEN_READONLY',
    'SPEI_PHRASE_START', 'SPSHORTCUTTYPE', 'SAFT8kHz8BitStereo',
    'DISPID_SVSyncronousSpeakTimeout', 'SVEAllEvents',
    'DISPID_SDKEnumValues', 'SAFT24kHz16BitStereo',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SPPFirstElement',
    'DISPID_SVSInputWordPosition', 'DISPID_SPISaveToMemory',
    'SVEPhoneme', 'SAFT32kHz8BitMono', 'DISPID_SPIStartTime',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SASCurrentDevicePosition', 'eLEXTYPE_VENDORLEXICON',
    'ISpRecoCategory', 'STSF_CommonAppData', 'SPEVENT',
    'eLEXTYPE_PRIVATE10', 'DISPID_SGRSTsItem', 'DISPID_SOTDataKey',
    'SVESentenceBoundary', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SpeechGrammarRuleStateTransition', '_ISpeechVoiceEvents',
    'SREHypothesis', 'SPWORDTYPE', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPEEngineConfidence',
    'DISPID_SPRulesCount', 'SGRSTTTextBuffer', 'DISPID_SRCESoundEnd',
    'SPINTERFERENCE_LATENCY_WARNING', 'ISpRecognizer',
    'SPPS_RESERVED2', 'DISPID_SGRsFindRule', 'SpObjectTokenCategory',
    'SPAR_Medium', 'SAFT22kHz16BitStereo', 'SGRSTTRule',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SRGRules',
    'SpeechRegistryUserRoot', 'SDTPronunciation',
    'DISPID_SWFESamplesPerSec', 'ISpeechRecoResult2',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SREStreamEnd', 'SITooSlow',
    'SpeechTokenKeyAttributes', 'DISPID_SPPValue',
    'SPSHORTCUTPAIRLIST', 'SPPS_Function', 'eLEXTYPE_PRIVATE15',
    'DISPID_SGRClear', 'SPXRO_Alternates_SML', 'SPAUDIOSTATUS',
    'DISPID_SpeechMemoryStream', 'SVSFDefault',
    'DISPID_SOTGetDescription', 'DISPID_SVSLastResult',
    'DISPID_SRRTTickCount', 'SAFT12kHz8BitMono',
    'SpeechRecognitionType', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SLPType', 'eLEXTYPE_PRIVATE4',
    'DISPID_SPANumberOfElementsInResult', 'LONG_PTR',
    'eLEXTYPE_RESERVED10', 'DISPID_SPPName', 'STCLocalServer',
    'DISPID_SWFEFormatTag', 'SPWT_DISPLAY', 'DISPID_SPIAudioSizeTime',
    'SpObjectToken', 'SSFMCreateForWrite', 'DISPID_SBSFormat',
    'SAFT16kHz16BitStereo', 'DISPID_SPRDisplayAttributes',
    'DISPID_SDKOpenKey', 'DISPID_SPAStartElementInResult',
    'DISPID_SPRFirstElement', 'SECFIgnoreKanaType',
    'SECHighConfidence', 'SPAR_Low', 'DISPID_SGRSTs_NewEnum',
    'SpNotifyTranslator', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SAFT8kHz8BitMono', 'DISPID_SRIsShared', 'DISPID_SpeechAudio',
    'DISPID_SRRTimes', 'DISPID_SPPNumberOfElements', 'DISPID_SPPId',
    'SPINTERFERENCE', 'SPRECOGNIZERSTATUS', 'SAFTADPCM_44kHzStereo',
    'DISPID_SVGetVoices', 'DISPID_SRCEventInterests',
    'SAFT24kHz8BitStereo', 'SAFTCCITT_uLaw_11kHzMono',
    'SPPS_Noncontent', 'DISPID_SPPChildren', 'SPEI_ADAPTATION',
    'DISPID_SPIAudioStreamPosition', 'SPDATAKEYLOCATION',
    'SSSPTRelativeToEnd', 'SPPS_RESERVED3', 'DISPID_SPEPronunciation',
    'SREPropertyStringChange', 'eLEXTYPE_APP', 'DISPID_SPRsCount',
    'SPEI_RECOGNITION', 'DISPID_SLWWord', 'SPSEMANTICERRORINFO',
    'DISPID_SOTRemoveStorageFileName', 'ISpObjectToken',
    'ISpStreamFormat', 'SGRSTTWord', 'SPPS_Verb',
    'DISPID_SOTCDefault', 'SLODynamic',
    'DISPID_SPERequiredConfidence', 'SASPause', 'SVSFParseSsml',
    'SRTStandard', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SCSBaseStream', 'SPFM_CREATE', 'SAFT16kHz8BitStereo',
    'SP_VISEME_11', 'DISPID_SpeechLexiconWords',
    'SDKLDefaultLocation', 'ISpeechAudio',
    'DISPID_SRRSetTextFeedback', 'SPPS_Unknown', 'SPSHT_Unknown',
    'SECFIgnoreCase', 'DISPID_SRCState', 'SRTSMLTimeout',
    'SpeechPropertyResponseSpeed', 'DISPID_SOTCId', 'SVSFVoiceMask',
    'SP_VISEME_2', 'DISPID_SASCurrentSeekPosition',
    'SpSharedRecoContext', 'ISpeechObjectTokenCategory',
    'DISPID_SGRSTRule', 'SPEVENTENUM',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SVEWord',
    'DISPID_SOTGetAttribute', 'SpeechDictationTopicSpelling',
    'DISPID_SRCEHypothesis', 'SPEI_SR_PRIVATE',
    'SPEI_TTS_AUDIO_LEVEL', 'SpVoice', 'SpeechRecoContextState',
    'DISPID_SASetState', 'DISPID_SRCEPhraseStart',
    'SECFEmulateResult', '_RemotableHandle', 'SPPS_Modifier',
    'SREAllEvents', 'eLEXTYPE_RESERVED9', 'SGSDisabled',
    'DISPID_SpeechPhoneConverter', 'SINoSignal',
    'SPEI_END_INPUT_STREAM', 'SpeechGrammarRuleStateTransitionType',
    'ISpeechGrammarRules', 'ISpeechMemoryStream', 'SDKLLocalMachine',
    'SpeechAudioFormatType', 'DISPID_SLWsItem',
    'SpeechPropertyResourceUsage', 'SpAudioFormat',
    'SpeechGrammarTagUnlimitedDictation', 'SPPS_LMA',
    'eLEXTYPE_PRIVATE14', 'ISpeechLexiconPronunciation',
    'DISPID_SVEEnginePrivate', 'DISPID_SGRs_NewEnum',
    'SAFTADPCM_8kHzMono', 'DISPID_SOTCSetId', 'SpPhraseInfoBuilder',
    'SPEI_REQUEST_UI', 'SPEI_RESERVED3', 'SpeechGrammarState',
    'SRERecognition', 'DISPID_SpeechRecoResult',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SVSkip',
    'DISPID_SRCreateRecoContext',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPSNotOverriden',
    'ISpeechPhraseReplacements', 'DISPID_SGRInitialState',
    'SPWORDPRONUNCIATIONLIST', 'SVEVoiceChange', 'SITooLoud',
    'ISpeechLexiconWord', 'DISPID_SPEDisplayAttributes',
    'SVSFParseSapi', 'SVPOver', 'SPRS_INACTIVE', 'DISPID_SVRate',
    'SVP_17', 'SPEI_MAX_TTS', 'ISpeechRecoResultTimes',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRRTStreamTime',
    'SPWAVEFORMATTYPE', 'SPWORDPRONUNCIATION', 'DISPID_SGRSRule',
    'SPEI_SOUND_END', 'DISPID_SGRSTPropertyValue',
    'DISPID_SRSAudioStatus', 'SP_VISEME_14', 'DISPID_SVEVoiceChange',
    'SVSFIsNotXML', 'ISpRecoContext2', 'DISPID_SLPLangId',
    'DISPID_SpeechCustomStream', 'DISPID_SRAudioInput',
    'DISPID_SABIEventBias', 'Speech_Max_Pron_Length',
    'DISPID_SPPConfidence', 'IEnumString', 'DISPID_SGRsCommit',
    'SpeechFormatType', 'DISPID_SASNonBlockingIO', 'SP_VISEME_15',
    'eLEXTYPE_PRIVATE12', 'ISpeechObjectToken', 'tagSTATSTG',
    'SPDKL_CurrentConfig', 'SLTApp',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPEI_RESERVED5',
    'SpeechPropertyNormalConfidenceThreshold', 'STCInprocHandler',
    'DISPID_SVESentenceBoundary', 'SP_VISEME_8',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SOTsCount',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRCEInterference',
    'DISPID_SPRNumberOfElements', 'eLEXTYPE_PRIVATE20',
    'DISPID_SPCPhoneToId', 'eWORDTYPE_DELETED', 'DISPID_SRGReset',
    'DISPID_SGRAttributes', 'DISPID_SPAsItem', 'SpeechCategoryVoices',
    'SGSExclusive', 'DISPID_SDKSetLongValue', 'SRSEIsSpeaking',
    'SpeechMicTraining', 'DISPID_SpeechLexicon',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SLGenerationId',
    'DISPID_SVEViseme', 'SPVOICESTATUS',
    'DISPID_SRCEFalseRecognition', 'UINT_PTR', 'SpeechUserTraining',
    'SVPAlert', 'DISPID_SPRText', 'SpeechRecoEvents',
    'DISPID_SpeechPhraseProperties', 'SPCATEGORYTYPE',
    'SpeechLoadOption', 'ISpGrammarBuilder', 'ISpSerializeState',
    'SITooQuiet', 'ISpeechVoiceStatus', 'DISPID_SPEAudioTimeOffset',
    'SPEI_RESERVED1', 'ISpeechObjectTokens', 'SPEI_INTERFERENCE',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SPIEnginePrivateData',
    'SpeechEmulationCompareFlags', 'DISPID_SRCESoundStart',
    'DISPID_SRGetFormat', 'DISPID_SpeechWaveFormatEx', 'SVP_20',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SLPSymbolic',
    'SpeechCategoryPhoneConverters', 'SPPHRASERULE',
    'SAFT44kHz16BitMono', 'DISPID_SRCRetainedAudio',
    'DISPID_SLPPhoneIds', 'DISPID_SRRTLength',
    'DISPID_SRCEPropertyStringChange', 'SAFT24kHz8BitMono',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'ISpRecoGrammar',
    'SPEI_END_SR_STREAM', 'DISPID_SDKDeleteValue', 'SP_VISEME_21',
    'Speech_Max_Word_Length', 'SPCT_COMMAND', 'SRAONone',
    'STSF_LocalAppData', 'DISPID_SVSVisemeId', 'SRESoundStart',
    'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SWFEChannels', 'DISPID_SVSCurrentStreamNumber', 'SRARoot',
    'DISPID_SPRuleNumberOfElements', 'WAVEFORMATEX',
    'SPEI_START_INPUT_STREAM', 'DISPID_SVGetAudioInputs',
    'DISPID_SpeechMMSysAudio', 'DISPID_SpeechPhraseInfo',
    'DISPID_SGRsDynamic', 'SAFT12kHz8BitStereo', 'DISPID_SAFType',
    'ISpeechPhraseAlternates', 'SAFT8kHz16BitStereo',
    'SAFT44kHz8BitStereo', 'ISpPhoneticAlphabetConverter',
    'SpeechVoiceCategoryTTSRate', 'SPEVENTSOURCEINFO',
    'SREAdaptation', 'DISPID_SVEAudioLevel', 'SDKLCurrentUser',
    'SPFM_CREATE_ALWAYS', 'SPPS_Noun', 'SpeechGrammarWordType',
    'ISpEventSource', 'SPEI_FALSE_RECOGNITION', 'SP_VISEME_9',
    'DISPID_SLRemovePronunciation', 'SECNormalConfidence',
    'DISPID_SRCEBookmark', 'DISPID_SpeechBaseStream',
    'DISPID_SVWaitUntilDone', 'SPBO_NONE',
    'DISPID_SRGCmdLoadFromObject', 'SPCT_SUB_COMMAND',
    'DISPID_SADefaultFormat', 'SPINTERFERENCE_NOSIGNAL',
    'SGDSActiveUserDelimited', 'SWPUnknownWordPronounceable',
    'SP_VISEME_0', 'DISPID_SVAudioOutputStream',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVEStreamEnd',
    'SECFIgnoreWidth', 'ISpeechPhraseInfoBuilder', 'DISPID_SGRName',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRCResume',
    'DISPID_SLGetPronunciations', 'SpeechAudioFormatGUIDWave',
    'SVEStartInputStream', 'SVEPrivate', 'SPSUnknown',
    'ISpeechGrammarRuleState', 'SPVPRIORITY', 'SREStreamStart',
    'SASStop', 'DISPID_SpeechPhraseAlternate', 'eLEXTYPE_PRIVATE17',
    'SAFT44kHz8BitMono', 'DISPID_SOTs_NewEnum', 'eLEXTYPE_PRIVATE19',
    'DISPID_SRSSupportedLanguages', 'ISpObjectTokenCategory',
    'SVF_Stressed', 'SPLEXICONTYPE', 'SPSHT_OTHER',
    'DISPID_SRProfile', 'SDTAlternates', 'ISpeechLexicon',
    'SPEI_PHONEME', 'SPEI_TTS_PRIVATE', 'SVP_9',
    '__MIDL_IWinTypes_0009', 'DISPID_SpeechAudioStatus',
    'SpeechSpecialTransitionType', 'DISPID_SLPsItem',
    'DISPID_SpeechXMLRecoResult', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPRST_ACTIVE', 'SAFT48kHz16BitMono', 'ISpeechPhraseElements',
    'DISPID_SVEBookmark', 'SpTextSelectionInformation', 'SVP_18',
    'SpeechVoicePriority', 'SPSHT_NotOverriden',
    'DISPID_SVSpeakStream', 'ISpRecognizer3', 'ISpResourceManager',
    'SDTRule', 'DISPID_SGRSTText', 'ISpNotifyTranslator',
    'DISPID_SRGetRecognizers', 'DISPID_SVSRunningState', 'SRTReSent',
    'SSFMOpenReadWrite', 'SpeechVisemeType',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SASState',
    'DISPID_SRSCurrentStreamNumber', 'SRTEmulated', 'STSF_AppData',
    'SDTProperty', 'SWPUnknownWordUnpronounceable', 'ISpeechVoice',
    'DISPID_SPRuleChildren', 'SASClosed', 'DISPID_SMSSetData',
    'DISPID_SRGCmdLoadFromFile', 'SRTAutopause',
    'ISpeechPhraseAlternate', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SpeechGrammarRules', 'SFTInput',
    'DISPID_SpeechPhraseRule', 'DISPID_SPCLangId',
    'ISpObjectWithToken', 'IStream', 'SpMemoryStream',
    'DISPID_SGRSAddSpecialTransition', 'SpNullPhoneConverter',
    'SPEI_HYPOTHESIS', 'SPSERIALIZEDPHRASE',
    'DISPID_SpeechRecoContextEvents', 'SGDSActive',
    'ISpeechPhraseReplacement', 'SPWT_PRONUNCIATION',
    'DISPID_SDKSetStringValue', 'SpeechCategoryAudioIn',
    'ISpeechTextSelectionInformation', 'DISPID_SRCEEnginePrivate',
    'DISPID_SpeechObjectToken', 'ISpeechAudioFormat', 'SpMMAudioIn',
    'SPPROPERTYINFO', 'ISpeechAudioStatus', 'tagSPTEXTSELECTIONINFO',
    'SVSFlagsAsync', 'DISPID_SBSRead', 'ISpeechPhraseProperty',
    'ISpShortcut', 'DISPID_SRCEAdaptation', 'DISPID_SGRsAdd',
    'eLEXTYPE_PRIVATE11', 'DISPID_SWFEBlockAlign', 'SPSVerb', 'SVP_1',
    'DISPID_SAVolume', 'SpeechInterference', 'SVSFIsXML', 'SVF_None',
    'ISpPhoneticAlphabetSelection', 'SVEViseme',
    'SpeechTokenShellFolder', 'SPVPRI_OVER', 'SPSMF_SAPI_PROPERTIES',
    'SPINTERFERENCE_NONE', 'DISPID_SVSpeak', 'SP_VISEME_6',
    'DISPID_SPEActualConfidence', 'SpeechTokenValueCLSID',
    '_SPAUDIOSTATE', 'SpeechBookmarkOptions', 'SAFTGSM610_22kHzMono',
    'SPWF_INPUT', 'SpMMAudioEnum', 'DISPID_SBSSeek', 'SVP_0',
    'SP_VISEME_17', 'SPPS_RESERVED1', 'SPAR_Unknown',
    'DISPID_SVEStreamStart', 'SPSModifier', 'SPPHRASEREPLACEMENT',
    'DISPID_SWFEBitsPerSample', 'SPWORDLIST',
    'DISPID_SOTMatchesAttributes', 'SPBO_AHEAD', 'DISPID_SRStatus',
    'SAFTCCITT_ALaw_22kHzMono', 'SGPronounciation',
    'DISPID_SpeechRecoContext', 'DISPID_SGRId', 'eLEXTYPE_PRIVATE5',
    'DISPID_SGRsCommitAndSave', 'DISPID_SGRSTNextState',
    'DISPID_SLGetGenerationChange', 'SVP_13', 'ISpNotifySource',
    'SPSTREAMFORMATTYPE', 'ISpProperties', 'SPAO_NONE',
    'SPADAPTATIONRELEVANCE', 'SPEI_START_SR_STREAM', 'SPSMF_UPS',
    'DISPID_SRGCmdLoadFromMemory', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SVPriority', 'SAFT44kHz16BitStereo', 'DISPID_SLWLangId',
    'SPCT_SUB_DICTATION', 'SpeechVoiceEvents', 'SPDKL_LocalMachine',
    'SpPhoneticAlphabetConverter', '_ISpeechRecoContextEvents',
    'DISPID_SOTCEnumerateTokens', 'eLEXTYPE_PRIVATE1',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVP_21',
    'DISPID_SGRAddState', 'SREFalseRecognition', 'STCRemoteServer',
    'eLEXTYPE_PRIVATE16', 'SVP_6', 'DISPID_SRGCommit',
    'DISPID_SDKGetBinaryValue', 'SPPHRASEELEMENT',
    'DISPID_SRRecognizer', 'DISPID_SPIReplacements', 'SRCS_Enabled',
    'DISPID_SPEs_NewEnum', 'SDA_One_Trailing_Space',
    'DISPID_SPPs_NewEnum', 'SAFT48kHz8BitMono', 'SGRSTTDictation',
    'SpeechRunState', 'DISPID_SABufferNotifySize',
    'DISPID_SRGetPropertyNumber', 'SAFT48kHz16BitStereo',
    'DISPID_SRGDictationUnload', 'DISPID_SRCBookmark',
    'SAFTGSM610_11kHzMono', 'SRERequestUI', 'DISPID_SRRPhraseInfo',
    'ISpVoice', 'SpWaveFormatEx', 'STSF_FlagCreate',
    'SAFTADPCM_11kHzMono', 'DISPID_SGRSTPropertyName',
    'SPPARTOFSPEECH', 'DISPID_SREmulateRecognition',
    'DISPID_SRCRecognizer', 'SGDisplay', 'SPSNoun',
    'SAFT11kHz16BitStereo', 'SPSERIALIZEDRESULT', 'SREBookmark',
    'SPWORDPRONOUNCEABLE', 'eLEXTYPE_RESERVED8', 'SPRULESTATE',
    'DISPID_SPEAudioSizeTime', 'DISPID_SRRAudioFormat', 'SDTAudio',
    'ISpeechPhraseElement', 'SBOPause', 'ISpeechWaveFormatEx',
    'DISPID_SABufferInfo', 'SpStream', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPERetainedSizeBytes', 'SpeechCategoryAppLexicons',
    'ISpeechMMSysAudio', 'DISPID_SpeechObjectTokenCategory',
    'SRAImport', 'SPWT_LEXICAL', 'SDTReplacement',
    'SRADefaultToActive', 'DISPID_SRGId', 'SPSFunction',
    'DISPID_SVGetProfiles', 'SP_VISEME_13', 'SRADynamic',
    'SpeechPartOfSpeech', 'SPEI_VISEME', 'SAFT8kHz16BitMono',
    'SpeechTokenIdUserLexicon', 'SDTAll', 'DISPID_SDKCreateKey',
    'DISPID_SPIEngineId', 'eLEXTYPE_PRIVATE7',
    'DISPID_SpeechPhraseBuilder',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'eLEXTYPE_PRIVATE13',
    'SRESoundEnd', 'SSFMCreate', 'eLEXTYPE_RESERVED6',
    'DISPID_SMSALineId', 'SGRSTTEpsilon', 'SP_VISEME_18',
    'DISPID_SpeechPhraseReplacements', 'SAFTDefault', 'SVP_12',
    'SPEI_MIN_SR', 'SpeechAudioProperties', 'ISpEventSink', 'STCAll',
    'DISPID_SMSADeviceId', 'DISPID_SVSInputSentenceLength',
    'SGLexicalNoSpecialChars', 'SPEI_TTS_BOOKMARK', 'SP_VISEME_1',
    'SpeechTokenKeyFiles', 'SAFTText', 'SPPHRASE',
    'DISPID_SVSLastBookmark', 'eLEXTYPE_PRIVATE18', 'ISpDataKey',
    'DISPID_SPRuleId', 'DISPID_SpeechLexiconWord',
    'DISPID_SpeechAudioFormat', 'ISpeechRecoResult',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVGetAudioOutputs',
    'DISPID_SPAPhraseInfo', 'ISpeechDataKey', 'SpeechDiscardType',
    'SVP_14', 'DISPID_SVPause', 'SPEI_RESERVED6', 'SPSHORTCUTPAIR',
    'DISPID_SOTCGetDataKey', 'SDA_No_Trailing_Space',
    'eLEXTYPE_PRIVATE8', 'DISPID_SpeechGrammarRule',
    'DISPID_SPIProperties', 'SAFT11kHz16BitMono',
    'SRSInactiveWithPurge', 'DISPID_SLGetWords', 'SpeechRuleState',
    'Speech_Default_Weight', 'DISPID_SpeechPhraseRules', 'SVP_2',
    'DISPID_SVSLastStreamNumberQueued', 'SRAInterpreter',
    'SPEI_SENTENCE_BOUNDARY', 'SpPhoneConverter',
    'DISPID_SAEventHandle', 'DISPID_SpeechVoice',
    'DISPID_SRCERequestUI', 'DISPID_SVEventInterests',
    'DISPID_SLPsCount', 'SPGS_EXCLUSIVE', 'SPINTERFERENCE_TOOQUIET',
    'SpeechAllElements', 'SP_VISEME_4', 'SPLOADOPTIONS',
    'SAFT16kHz8BitMono', 'SVP_5', 'SREInterference',
    'tagSPPROPERTYINFO', 'SASRun', 'DISPID_SpeechDataKey',
    'SPEI_MAX_SR', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SVAudioOutput',
    'ISpeechAudioBufferInfo', 'DISPID_SFSOpen', 'eLEXTYPE_PRIVATE9',
    'SWTDeleted', 'DISPID_SPRuleConfidence',
    'ISpStreamFormatConverter', 'SPRST_INACTIVE',
    'SpInProcRecoContext', 'Speech_StreamPos_Asap', 'DISPID_SRState',
    'SPCT_SLEEP', 'SPPS_RESERVED4', 'SAFT22kHz8BitMono', 'ISpStream',
    'SP_VISEME_20', 'DISPID_SPILanguageId', 'ISpLexicon',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SDKSetBinaryValue',
    'eWORDTYPE_ADDED', 'SVSFPersistXML', 'ISpNotifySink', 'SVPNormal',
    'SAFTCCITT_uLaw_8kHzStereo', 'IInternetSecurityManager',
    'SPRST_ACTIVE_ALWAYS', 'SAFTCCITT_uLaw_22kHzMono', 'SpShortcut',
    'ISpeechPhraseRule', 'SPVPRI_NORMAL',
    'DISPID_SRCRetainedAudioFormat', 'ISpeechBaseStream',
    'DISPID_SGRSTWeight', 'DISPID_SRAudioInputStream',
    'SPCONTEXTSTATE', 'DISPID_SPEsCount', 'SPRST_INACTIVE_WITH_PURGE',
    'SAFTCCITT_uLaw_44kHzStereo', 'SSTTWildcard',
    'DISPID_SpeechPhraseElements', 'SAFTExtendedAudioFormat',
    'SLOStatic', 'ISpRecognizer2', 'SRCS_Disabled',
    'DISPID_SDKGetlongValue', 'SAFTADPCM_22kHzStereo',
    'SPSSuppressWord', 'SVF_Emphasis', 'DISPID_SVSpeakCompleteEvent',
    'ISpeechPhoneConverter', 'DISPID_SGRSTransitions',
    'SGDSActiveWithAutoPause', 'SPSHT_EMAIL',
    'SpeechPropertyAdaptationOn', 'DISPID_SAStatus',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRGState',
    'DISPID_SPRuleParent', 'SGSEnabled', 'DISPID_SLPPartOfSpeech',
    'SDA_Two_Trailing_Spaces', 'ISpRecoContext', 'SPBO_TIME_UNITS',
    'DISPID_SPELexicalForm', 'SGLexical', 'DISPID_SRGIsPronounceable',
    'DISPID_SOTCategory', 'SPAUDIOSTATE', 'SVSFParseAutodetect',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SpeechLexiconProns', 'SP_VISEME_10',
    'SpeechGrammarTagWildcard', 'DISPID_SPEAudioStreamOffset',
    'SREPhraseStart', 'SPLO_DYNAMIC', 'SREPrivate',
    'DISPID_SRCEEndStream', 'SpeechTokenContext',
    'SAFT48kHz8BitStereo', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SDKDeleteKey', 'SPINTERFERENCE_TOOLOUD',
    'SPEI_SR_BOOKMARK', 'SpeechPropertyHighConfidenceThreshold',
    'SPAS_RUN', 'SpeechLexiconType', 'DISPID_SpeechRecognizerStatus',
    'DISPIDSPRG', 'SpeechVoiceSpeakFlags', 'SPEI_MIN_TTS',
    'SVSFUnusedFlags', 'SINone', 'SPRULE', 'SPXRO_SML',
    'DISPID_SVEPhoneme', 'SVP_19', 'SpeechRuleAttributes',
    'SDA_Consume_Leading_Spaces', 'DISPID_SVResume', 'SP_VISEME_12',
    'SREPropertyNumChange', 'SAFTADPCM_8kHzStereo',
    'DISPID_SGRsCount', 'DISPID_SpeechPhraseElement',
    'DISPID_SPEDisplayText', 'SDTDisplayText', 'DISPID_SRRSpeakAudio',
    'SAFT16kHz16BitMono', 'SpeechRetainedAudioOptions',
    'SP_VISEME_16', 'ISpeechRecoContext', 'SPBO_PAUSE',
    'SpUnCompressedLexicon', 'SPFILEMODE', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRSCurrentStreamPosition', 'SPEI_RECO_STATE_CHANGE',
    'SRERecoOtherContext', 'SAFT11kHz8BitStereo',
    'DISPID_SVSPhonemeId', 'DISPID_SpeechRecognizer',
    'ISpeechPhraseProperties', 'DISPID_SRCEStartStream',
    'SRTExtendableParse', 'DISPID_SPRs_NewEnum', 'SPDKL_CurrentUser',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRRAlternates',
    'SpeechCategoryRecognizers', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SOTRemove', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SPIGetText', 'SLTUser', 'SINoise',
    'DISPID_SABIMinNotification', 'DISPID_SPIRule',
    'ISpeechLexiconWords', 'SAFTNoAssignedFormat', 'DISPID_SLWType',
    'DISPID_SRSetPropertyString', 'DISPID_SMSAMMHandle',
    'SPRST_NUM_STATES', 'ISpRecoResult', 'SPRS_ACTIVE',
    'DISPID_SRRRecoContext', 'SVEEndInputStream',
    'SECFNoSpecialChars', 'STCInprocServer', 'SAFTGSM610_8kHzMono',
    'ISpPhrase', 'DISPID_SVIsUISupported', 'DISPID_SPPParent',
    'SpeechCategoryRecoProfiles', 'SPGRAMMARWORDTYPE',
    'SPSEMANTICFORMAT', 'SPAS_PAUSE', 'SAFTCCITT_uLaw_8kHzMono',
    'SPLO_STATIC', 'DISPIDSPTSI_SelectionOffset', 'ISpeechPhraseInfo',
    'DISPID_SRIsUISupported', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRGDictationSetState',
    'SpeechPropertyLowConfidenceThreshold', 'SVSFPurgeBeforeSpeak',
    'SPXMLRESULTOPTIONS', 'DISPID_SPARecoResult',
    'DISPID_SVSInputWordLength', 'DISPID_SPACommit',
    'DISPID_SLWs_NewEnum', 'DISPID_SPERetainedStreamOffset',
    'ISpPhraseAlt', 'SREAudioLevel', 'SPBOOKMARKOPTIONS',
    'SPGS_ENABLED', 'SREStateChange', 'SECFDefault', 'SSTTDictation',
    'DISPID_SGRSAddRuleTransition',
    'DISPID_SRCERecognitionForOtherContext', 'SPAUDIOBUFFERINFO',
    'DISPID_SPPsCount', 'SVEBookmark', 'SPCS_DISABLED',
    'DISPID_SRRAudio', 'DISPID_SABIBufferSize', 'SPGS_DISABLED',
    'SAFT12kHz16BitStereo', 'SAFT22kHz16BitMono',
    'DISPID_SAFGetWaveFormatEx', 'SPEI_SOUND_START',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'ISpeechRecognizer',
    'eLEXTYPE_PRIVATE3', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SPIElements', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SDKLCurrentConfig', 'SpeechAudioVolume', 'SPINTERFERENCE_NOISE',
    'SpeechDataKeyLocation', 'DISPID_SLWPronunciations', 'SVP_8',
    'SAFTADPCM_11kHzStereo', 'SpResourceManager',
    'DISPID_SOTCreateInstance', 'SWPKnownWordPronounceable',
    'DISPID_SpeechPhraseProperty', 'eLEXTYPE_PRIVATE2',
    'SAFT24kHz16BitMono', 'SpeechWordType', 'SGRSTTWildcard',
    'SP_VISEME_3', 'DISPID_SRGetPropertyString',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRCCreateResultFromMemory', 'SSSPTRelativeToStart',
    'DISPID_SRRDiscardResultInfo', 'SpeechTokenKeyUI',
    'DISPID_SWFEExtraData', 'SpeechRecoProfileProperties',
    'DISPID_SRCERecognition', 'DISPID_SPPEngineConfidence',
    'SpLexicon', 'SpeechEngineProperties'
]

_check_version('1.1.14', 1680598693.838424)
